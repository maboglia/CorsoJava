Un dizionario è una raccolta di coppie chiave-valore. La classe astratta
...
String getProperty(String key)		Restituisce il valore dalla
					proprietà chiamata key, o null
					se tale proprietà non esiste.
String getProperty(String key,		Restituisce il valore dalla
String defaultValue)			proprietà chiamata key, o
					defaultValue se tale proprietà
					non esiste.
list(java.io.PrintStream out)		Elenca tutte le proprietà nel
					canale out.
